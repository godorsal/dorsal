(function () {
    ...
    function fileUpload() {
        ...
        var directive = {
            ...
            '<a ng-click="openFile(attachment.dataStreamContentType, attachment.dataStream)" style="font-size: 20px; margin-right: 7px;">' +
            '<i class="fa fa-search fa-lg" aria-hidden="true"></i>' +
            '</a>' +
            '<a href="data:application/octet-stream;charset=utf-16le;base64,{{attachment.dataStream}}" download="{{attachment.name}}" style="font-size: 20px; margin-right: 7px;">' +
            '<i class="fa fa-download fa-lg" aria-hidden="true"></i>' +
            '</a>' +
            '<a ng-click="deleteAttachment(attachment, $index)" style="font-size: 25px; margin-right: 7px;">' +
