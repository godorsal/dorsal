...
public class UserResource {
    ...
    public ResponseEntity<List<ManagedUserVM>> getAllUsers(Pageable pageable)
        ...
        Page<User> page = userRepository.findAllAdminIsCurrentUser(pageable);
     ...
     *
     * @param value the email of the user to find
    ...
    @RequestMapping(value = "/users/email/{value:" + Constants.LOGIN_REGEX + "}",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<ManagedUserVM> getUserByEmail(@PathVariable String value) {
     ...
     *
     * @param value the login of the user to find
     * @return the ResponseEntity with status 200 (OK) and with body the "email" user, or with status 200 with null user value
     */
    @RequestMapping(value = "/users/login/{value:" + Constants.LOGIN_REGEX + "}",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<ManagedUserVM> getUserByLogin(@PathVariable String value) {
        log.debug("REST request to get User : {}", value);
