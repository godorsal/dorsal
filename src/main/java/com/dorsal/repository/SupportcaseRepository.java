...
public interface SupportcaseRepository extends JpaRepository<Supportcase,Long> {
    ...
    @Query(value = "select supportcase from Supportcase supportcase where supportcase.expertaccount.user.login = ?#{principal.username}  ORDER BY supportcase.dateCreated ASC",
    ...
    @Query(value = "select supportcase from Supportcase supportcase where supportcase.user.login = ?#{principal.username} ORDER BY supportcase.dateCreated ASC",
