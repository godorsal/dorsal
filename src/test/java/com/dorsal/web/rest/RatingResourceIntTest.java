...
public class RatingResourceIntTest {
    ...
    private static final String DEFAULT_RATING_COMMENTS = "";
    private static final String UPDATED_RATING_COMMENTS = "";
    ...
    public void initTest() {
        ...
        rating.setRatingComments(DEFAULT_RATING_COMMENTS);
    }
...
//        assertThat(testRating.getDateRated()).isEqualTo(DEFAULT_DATE_RATED);
        ...
        assertThat(testRating.getRatingComments()).isEqualTo(DEFAULT_RATING_COMMENTS);
    }
    ...
    public void getAllRatings() throws Exception {
        ...
        restRatingMockMvc.perform(get("/api/ratings?sort=id,desc"))
                ...
                .andExpect(jsonPath("$.[*].ratingComments").value(hasItem(DEFAULT_RATING_COMMENTS.toString())));
    }
    ...
    public void getRating() throws Exception {
        ...
        restRatingMockMvc.perform(get("/api/ratings/{id}", rating.getId()))
            ...
            .andExpect(jsonPath("$.ratingComments").value(DEFAULT_RATING_COMMENTS.toString()));
    }
    ...
    public void updateRating() throws Exception {
        ...
        updatedRating.setRatingComments(UPDATED_RATING_COMMENTS);
        ...
        assertThat(testRating.getRatingComments()).isEqualTo(UPDATED_RATING_COMMENTS);
    }
